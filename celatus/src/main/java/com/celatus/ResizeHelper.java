...
/**
 * Helper class to resize undecorated windows. Taken from :
 * https://stackoverflow.com/questions/19455059/allow-user-to-resize-an-undecorated-stage (credits
 * to https://stackoverflow.com/users/325554/alexander-berg)
 */
    ...
    public void handle(MouseEvent mouseEvent) {
      ...
      if (MouseEvent.MOUSE_PRESSED.equals(mouseEventType)) {
        ...
        if (mouseEvent.getTarget() instanceof AnchorPane) {
          double offsetX = mouseEvent.getScreenX() - startScreenX;
          double offsetY = mouseEvent.getScreenY() - startScreenY;

          double newStageX = stage.getX() + offsetX;
          double newStageY = stage.getY() + offsetY;

          // Check if newStageX and newStageY are within valid bounds, if needed
